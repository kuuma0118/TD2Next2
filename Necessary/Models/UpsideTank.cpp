#include "UpsideTank.h"

Microsoft::WRL::ComPtr<ID3D12Resource> UpsideTank::CreateBufferResource(const Microsoft::WRL::ComPtr<ID3D12Device>& device, size_t sizeInBytes) {
	HRESULT hr;
...
void UpsideTank::CreateMaterialResource() {
...
void UpsideTank::CreateWvpResource() {
...
void UpsideTank::Initialize() {

	modelData_ = ObjManager::GetInstance()->GetObjModelData()[UpsideTankM];
