#include "DownsideTank.h"
Microsoft::WRL::ComPtr<ID3D12Resource> DownsideTank::CreateBufferResource(const Microsoft::WRL::ComPtr<ID3D12Device>& device, size_t sizeInBytes) {
	HRESULT hr;
...
void DownsideTank::CreateMaterialResource() {
...
void DownsideTank::CreateWvpResource() {
